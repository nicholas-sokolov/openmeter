...
var (
	...
	BillingInvoiceLinesTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BillingInvoiceLinesColumns[2], BillingInvoiceLinesColumns[37]},
			},
			{
				Name:    "billinginvoiceline_namespace_parent_line_id_child_unique_reference_id",
				Unique:  true,
				Columns: []*schema.Column{BillingInvoiceLinesColumns[2], BillingInvoiceLinesColumns[37], BillingInvoiceLinesColumns[29]},
				Annotation: &entsql.IndexAnnotation{
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BillingStandardInvoiceDetailedLinesColumns[1]},
				Annotation: &entsql.IndexAnnotation{
					Types: map[string]string{
						"postgres": "GIN",
					},
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BillingStandardInvoiceDetailedLinesColumns[2]},
			},
			{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{BillingStandardInvoiceDetailedLinesColumns[2], BillingStandardInvoiceDetailedLinesColumns[31]},
			},
			{
				Name:    "billingstdinvdetailedline_ns_parent_child_id",
				Unique:  true,
				Columns: []*schema.Column{BillingStandardInvoiceDetailedLinesColumns[2], BillingStandardInvoiceDetailedLinesColumns[31], BillingStandardInvoiceDetailedLinesColumns[24]},
				Annotation: &entsql.IndexAnnotation{
					Where: "child_unique_reference_id IS NOT NULL AND deleted_at IS NULL",
				},
			},
	...
	BillingStandardInvoiceDetailedLineAmountDiscountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  true,
				Columns: []*schema.Column{BillingStandardInvoiceDetailedLineAmountDiscountsColumns[1], BillingStandardInvoiceDetailedLineAmountDiscountsColumns[12], BillingStandardInvoiceDetailedLineAmountDiscountsColumns[5]},
				Annotation: &entsql.IndexAnnotation{
					Where: "child_unique_reference_id IS NOT NULL AND deleted_at IS NULL",
				},
			},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{ChargeCreditPurchasesColumns[24]},
				RefColumns: []*schema.Column{CustomersColumns[0]},
				OnDelete:   schema.NoAction,
			},
			{
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  true,
				Columns: []*schema.Column{ChargeCreditPurchasesColumns[13], ChargeCreditPurchasesColumns[24], ChargeCreditPurchasesColumns[8]},
				Annotation: &entsql.IndexAnnotation{
					Where: "unique_reference_id IS NOT NULL AND deleted_at IS NULL",
				},
			},
	...
	ChargeUsageBasedColumns = []*schema.Column{
		...
		{Name: "price", Type: field.TypeString, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "status_detailed", Type: field.TypeEnum, Enums: []string{"created", "active", "active.final_realization.started", "active.final_realization.waiting_for_collection", "active.final_realization.processing", "active.final_realization.completed", "final"}},
