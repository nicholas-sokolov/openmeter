...
func initializeApplication(ctx context.Context, conf config.Configuration) (Application, func(), error) {
	...
	billingService, err := common.BillingService(logger, service, adapter, ratingService, customerService, featureConnector, meterService, connector, eventbusPublisher, billingConfiguration, subscriptionServiceWithWorkflow, client, billingFeatureSwitchesConfiguration, tracer)
	if err != nil {
		cleanup7()
		cleanup6()
		cleanup5()
	...
	appstripeService, err := common.NewAppStripeService(logger, client, appsConfiguration, service, customerService, secretserviceService, billingService, eventbusPublisher, invoicesyncService)
	if err != nil {
		cleanup7()
		cleanup6()
		cleanup5()
	...
	worker, err := common.NewBillingWorker(workerOptions, service, appstripeService, secretserviceService, billingService, eventbusPublisher, logger, invoicesyncadapterAdapter)
	if err != nil {
		cleanup7()
		cleanup6()
		cleanup5()
